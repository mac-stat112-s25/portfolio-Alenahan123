...
>The range of score is roughly around from 830 to 1100. The typical outcome is 900 and 1050, and there are two peaks in gragh , which indicates this gragh may be a bi-model.
...
>The relationship is negative, as the higher the student expenditure and teacher salary, the worse the SAT performance.
...
>These states with low education funding typically have lower SAT participation rates because local colleges may not require SAT scores. Only a subset of students—usually high-achieving students aiming for top universities—choose to take the exam. As a result, the average SAT scores in these states tend to be higher.
...
>values are similar in verbal, math and sat. There are two outlier in ratio one is Utah and another is California. In addition, it is obvious states  having high ratios have generally low expenditures per student.
