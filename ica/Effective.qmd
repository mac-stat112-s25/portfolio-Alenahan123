...
>The provided climate change plot is unethical primarily because of visual distortion through manipulative y-axis scaling. By not starting the y-axis at zero, the plot minimizes the apparent rise in temperature, which can falsely suggest that climate change is not a serious or accelerating issue. This kind of distortion:
Misleads the viewer by downplaying real trends;
May undermine scientific consensus on climate urgency;
Can be used to delay or discourage policy action, especially among uninformed or skeptical audiences;
Erodes trust in data communication when discovered.
...
>Visibility & Embodiment: Instead of reducing people to counts, it gives form to individual stories, emphasizing the human side of the issue.
...
>The data graphic tells a story about the distribution of gun-related deaths in the United States, broken down by cause (homicide, suicide, accidental) and possibly by age and gender. The main takeaway is how suicides far outnumber homicides, and how patterns vary significantly by demographic group.
>What Works Well:
Color coding is clear and intuitive—red for violence, blue for suicide helps convey emotional tone.
Layout helps tell a compelling narrative, especially if the chart is annotated or ordered by cause.
>Consider faceting by gender or race to give more nuanced insights.
